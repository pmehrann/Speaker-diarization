...
parser.add_argument('--resume', default=r'pretrained/VCTK_weights.h5', type=str)
...
def load_data(path_spk_tuples, win_length=400, sr=16000, hop_length=160, n_fft=512, min_win_time=240, max_win_time=1600):
    """
    hop_length is the number of samples between analysis frames
    """
...
def main():
    ...
    import ghostvlad.model as model
    ...
    # read wav files
    SRC_PATH = r'/home/pmehrann/diarization_dec/2speakers/'
    # SRC_PATH = r'E:\Projects\Speech recognition\Codes\Speaker-Diarization\ghostvlad\4persons'
