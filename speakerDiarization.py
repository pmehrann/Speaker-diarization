...
parser.add_argument('--resume', default=r'ghostvlad/pretrained/VCTK_weights_shayan.h5', type=str)
...
SAVED_MODEL_NAME = 'saved_model.uisrnn_benchmark_pouya'
...
if __name__ == '__main__':
    main(r'wavs/trump_bugs.wav', embedding_per_second=1.2, overlap_rate=0.4)
